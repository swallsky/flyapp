    ...
    return (
        <PageHeader title="配置" subTitle="全局配置信息">
            ...
            <Descriptions size="small" column={2}>
                <Descriptions.Item label=""><Button type='primary' onClick={openDir}>请选择目录</Button></Descriptions.Item>
                <Descriptions.Item label="文件切片大小">2M</Descriptions.Item>
                <Descriptions.Item label="本地保存目录">{saveDir}</Descriptions.Item>
...
const mapStateToProps = (state) => {
  ...
  export default connect(mapStateToProps, mapDisptchToProps)(Conf);